...
function getConfigurationColumnValueForRule(context, ruleName, severityType) {
    ...
    const emojis = getEmojisForConfigsSettingRuleToSeverity(context, ruleName, severityType);
    return emojis.join(' ');
}
...
function getRulesAndHeadersForSplit(context, ruleNamesAndRules, ruleListSplit) {
    ...
    for (const ruleListSplitItem of ruleListSplit) {
        ...
        for (const value of valuesNew.toSorted((a, b) => String(a).toLowerCase().localeCompare(String(b).toLowerCase()))) {
