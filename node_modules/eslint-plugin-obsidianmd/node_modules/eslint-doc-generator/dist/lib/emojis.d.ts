...
export declare const EMOJI_CONFIGS: {
    ...
    errors: string;
    recommended: string;
    'recommended-type-aware': string;
    'recommended-type-checked': string;
    strict: string;
    style: string;
    stylistic: string;
    ts: string;
...
export declare const EMOJI_DESCRIPTION = "\uD83D\uDCDD";
/**
...
export declare const RESERVED_EMOJI_SET: ReadonlySet<string>;
