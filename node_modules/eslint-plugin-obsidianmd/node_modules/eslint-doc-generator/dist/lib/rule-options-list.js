...
function generateRuleOptionsListMarkdown(context, rule) {
    const ruleOptions = getAllNamedOptions(rule.meta?.schema, rule.meta?.defaultOptions);
...
export function updateRuleOptionsList(context, markdown, rule) {
