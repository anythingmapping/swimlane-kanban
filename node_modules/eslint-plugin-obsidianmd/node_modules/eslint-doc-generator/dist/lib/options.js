...
export function getResolvedOptions(plugin, userOptions = {}) {
    ...
    const aiProvider = userOptions.aiProvider ?? OPTION_DEFAULTS[OPTION_TYPE.AI_PROVIDER];
    ...
    const suggestEmojis = userOptions.suggestEmojis ?? OPTION_DEFAULTS[OPTION_TYPE.SUGGEST_EMOJIS];
