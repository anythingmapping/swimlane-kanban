...
export function replaceRulePlaceholder(pathOrPathFunc, ruleName) {
 ...
 */
export function getUrlToRule(context, ruleName, ruleSource, pathToFile) {
    ...
    const urlRuleDocFunctionEvaluated = typeof urlRuleDoc === 'function'
        ...
        : undefined;
    const pathRuleDocEvaluated = join(getPluginRoot(path), replaceRulePlaceholder(pathRuleDoc, ruleNameWithoutPluginPrefix));
    return (
...
export function getMarkdownLink(text, includeBackticks, url) {
 ...
 */
export function getLinkToRule(context, ruleName, pathToFile, includeBackticks, includePrefix) {
    ...
    const ruleString = includePrefix && ruleNameWithPluginPrefix
